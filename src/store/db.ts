...
function buildAccounts(): AuthAccount[] {
  return [
    {
      id: 'usr_001',
...
export const db = {
  ...
  coupons: [
    { code: 'SAVE10', type: 'percent' as const, value: 10, minOrder: 500, active: true },
    { code: 'FLAT200', type: 'flat' as const, value: 200, minOrder: 999, active: true },
    { code: 'WELCOME15', type: 'percent' as const, value: 15, minOrder: 1000, active: true },
  ],
  flaggedReviews: [
    { id: 'rev_001', productId: 'p001', product: 'iPhone 15 Pro Max', reviewer: 'user_xyz', rating: 1, content: 'This product is fake! Complete fraud. Do not buy from this seller.', reason: 'Inappropriate language', date: '2024-06-28', status: 'pending' as const },
    { id: 'rev_002', productId: 'p002', product: 'Sony WH-1000XM5', reviewer: 'angry_buyer', rating: 1, content: 'My competitor told me to write this review to harm their sales', reason: 'Suspected fake review', date: '2024-06-27', status: 'pending' as const },
    { id: 'rev_003', productId: 'p010', product: 'Nike Air Max 270', reviewer: 'shopper_99', rating: 5, content: 'Best product ever! Visit my website for more deals: spam.com', reason: 'Spam/promotional content', date: '2024-06-26', status: 'pending' as const },
    { id: 'rev_004', productId: 'p018', product: 'Himalaya Face Wash', reviewer: 'review_bot_12', rating: 5, content: 'Amazing product amazing product amazing amazing five stars', reason: 'Bot-generated content', date: '2024-06-25', status: 'reviewing' as const },
    { id: 'rev_005', productId: 'p012', product: "Levi's 511 Jeans", reviewer: 'troll_user', rating: 2, content: 'The seller called me a bad name and I\'m very upset. Personal attack.', reason: 'Off-topic content', date: '2024-06-24', status: 'approved' as const },
    { id: 'rev_006', productId: 'p003', product: 'Samsung Galaxy S24', reviewer: 'fake_acc_44', rating: 1, content: 'Worst ever! This product broke in 1 day, never buying again, seller fraud!', reason: 'Unverified claim', date: '2024-06-23', status: 'rejected' as const },
  ] as FlaggedReview[],
  flaggedProducts: [
    { id: 'prd_f01', product: 'Cheap iPhone Clone 15', seller: 'FastDeals99', reason: 'Counterfeit / brand impersonation', category: 'Electronics', price: 2999, date: '2024-06-29', status: 'pending' as const },
    { id: 'prd_f02', product: 'Generic Headphones XM5 Pro', seller: 'AliDeals', reason: 'Misleading title (copy of Sony model)', category: 'Electronics', price: 499, date: '2024-06-28', status: 'pending' as const },
    { id: 'prd_f03', product: 'Weight Loss Pills 100% Guaranteed', seller: 'HealthKing', reason: 'Unverified health claims', category: 'Health', price: 1299, date: '2024-06-27', status: 'reviewing' as const },
    { id: 'prd_f04', product: 'Fake Designer Bag LV Style', seller: 'LuxuryReplica', reason: 'Trademark infringement', category: 'Fashion', price: 799, date: '2024-06-26', status: 'removed' as const },
    { id: 'prd_f05', product: 'Expired Skin Cream Bundle', seller: 'BeautyHub', reason: 'Expired product listing', category: 'Beauty', price: 349, date: '2024-06-25', status: 'removed' as const },
  ] as FlaggedProduct[],
...
export function logAudit(actor: string, action: string, resource: string, details: string) {
  const entry = {
    id: generateId('aud'),
    actor,
    action,
...
export function sellerMatches(productSellerId: string, sellerId: string): boolean {
