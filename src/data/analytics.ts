...
export const monthlyRevenue: DataPoint[] = [
...
// Weekly orders
export const weeklyOrders: DataPoint[] = [
...
export const categorySales: DataPoint[] = [
...
export const platformGMV: DataPoint[] = [
...
export const returnRates: DataPoint[] = [
...
export const dailyVisitors: DataPoint[] = Array.from({ length: 30 }, (_, i) => ({
  label: `Day ${i + 1}`,
...
export const earningsTimeline: DataPoint[] = [
...
export const orderStatusDist: DataPoint[] = [
...
export const userGrowth: DataPoint[] = [
...
export const regionalSales: DataPoint[] = [
