...
async function bootstrap() {
    ...
    try {
        ...
        console.log(`✓ Connected to PostgreSQL ${process.env.DB_HOST}:${process.env.DB_PORT}/${process.env.DB_NAME}`);
        const counts = await hydrateFromDatabase(db);
        console.log(`✓ Hydrated from DB — users:${counts.users} products:${counts.products} orders:${counts.orders} sellers:${counts.sellers}`);
