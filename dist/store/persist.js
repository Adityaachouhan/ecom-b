...
export async function saveSellerSettlement(settlement) {
...
export async function saveNotificationTemplate(template) {
...
export async function saveNotificationLog(log) {
...
export async function saveDeliveryPartner(partner) {
    ...
    await prisma.deliveryPartner.upsert({
        ...
        create: {
            ...
            kycDocuments: partner.kycDocuments,
...
export async function saveDeliveryEarning(earning) {
